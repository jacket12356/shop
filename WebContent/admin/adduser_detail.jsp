 ...
 <div class="rt_content">
      ...
      <ul class="ulColumn2">
       ...
       <li>
        ...
        <input type="text" class="textbox textbox_225" value="DeathGhost" placeholder="收货地址..."/>
       </li>
       <li>
        <span class="item_name" name="info" style="width:120px;">个人信息：<br/><br/><br/><br/><br/><br/><br/><br/></span>
        <textarea class="textbox textbox_225" value="DeathGhost" placeholder="个人信息..." style="height:200px;"></textarea>
       </li>
       <li>
